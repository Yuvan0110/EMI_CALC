...
//                                            TableCell("%.2f".format(yearEntry.percent) + " %", dynamicColWidth)
//                                        }
//                                        if (isExpanded) {
...
//                                                    TableCell("%.2f".format(monthEntry.percent) + " %", dynamicColWidth)
//                                                }
//                                            }
//                                        }
//                                    }
...
//                ) {
//                    Button(
//                        onClick = { writeDataToFile(viewModel) }
//                    ) {
...
//        table.forEach {
//            writer.write("${it.month}     ${String.format("%.2f", it.principalComponent)}    ${String.format("%.2f", it.interestComponent)}    ${String.format("%.2f", it.totalAmount)}    ${String.format("%.2f", it.balance)}    ${String.format("%.2f", it.percent) + '%'} \n")
//        }
//    }
//}
//
...
//        row.createCell(5).setCellValue(table[i - 1].percent)
//    }
